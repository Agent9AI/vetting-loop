...
/**
 * NEXT_PUBLIC_MOCK_IDENTITY=pseudonym replaces real names with neutral
 * labels. Use it for any public deployment while findings are synthetic.
 */
export const IDENTITY_MODE: IdentityMode =
  process.env.NEXT_PUBLIC_MOCK_IDENTITY === "pseudonym" ? "pseudonym" : "named";
