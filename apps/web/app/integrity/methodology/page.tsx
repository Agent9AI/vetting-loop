...
export const metadata: Metadata = {
  title: "Methodology · Integrity Index | The Vetting Loop",
};
  ...
  return (
    <main>
      <PageHeader
        ...
        title="How the Integrity Index works"
      ...
      <div className="mx-auto max-w-4xl space-y-10 px-4 py-10">
        ...
        <section className="rounded-mz border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
          ...
          <p className="mt-1">
            The 20 profiles use the 2024 Cabinet vetting roster as a placeholder. Every finding and rating is synthetic,
            assigned by a hash of the profile identifier against a fixed distribution (8 clear, 6 low, 4 elevated, 2 high),
            so no mock rating reflects the person&apos;s public reputation. The roster will be replaced with the 2027
            candidate list.
          </p>
        </section>
      </div>
