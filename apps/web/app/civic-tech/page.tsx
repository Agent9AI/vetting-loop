...
export const metadata: Metadata = {
  title: "Civic Tech Tools | The Vetting Loop",
};
...
const TOOLS: Array<{ name: string; href: string; blurb: string; icon: React.ReactNode; badge?: string }> = [
  {
    ...
    href: "/integrity",
    badge: "New",
    blurb: "15-year integrity records from EACC, the Auditor-General, Parliament and Mzalendo.",
    icon: (
  ...
  {
    name: "The Vetting Loop",
    href: "/",
    blurb: "Nominee dossiers, citizen questions, hearing records and per-MP vote trails.",
    icon: (
      <svg viewBox="0 0 64 64" className="h-20 w-20" fill="none" stroke="currentColor" strokeWidth="4">
        <path d="M50 22A20 20 0 1 0 52 36" strokeLinecap="round" />
        <path d="M52 10v13H39" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
